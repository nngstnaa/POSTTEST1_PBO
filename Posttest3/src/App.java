    ...
    static void tampilkanData(ArrayList<HarryPotter> Hp) {
        ...
        for (HarryPotter barang : Hp) {
            ...
            if (barang instanceof Novel) {
                ...
                System.out.println("Judul Novel        : " + ((Novel) barang).getJudulNovel());
            } else if (barang instanceof PernakPernik) {
                System.out.println("Jenis Barang       : Pernak Pernik");
                System.out.println("Nama Pernak Pernik : " + ((PernakPernik) barang).getNamaPernakPernik());
            }
...
static void tambahData(ArrayList<HarryPotter> Hp, BufferedReader br) throws IOException {
    System.out.println(
            "----------------------------------------------------------");
    System.out.println(
            "| Silahkan Memilih Jenis Barang yang Ingin Ditambahkan   |");
    System.out.println(
            "----------------------------------------------------------");
...
static void tambahNovel(ArrayList<HarryPotter> Hp, BufferedReader br) throws IOException {
    System.out.println(
            "-----------------------------------------------------");
    System.out.println(
            "| Silahkan Menambah Data Novel di Toko Wizardneeds  |");
    System.out.println(
            "-----------------------------------------------------");

    System.out.println("Masukkan ID Novel       :");
    String idNovel = br.readLine();
    System.out.println("Masukkan Judul Novel    :");
    String judulNovel = br.readLine();
    System.out.println("Masukkan Stok Novel     :");
    int stokNovel = Integer.parseInt(br.readLine());
    System.out.println("Masukkan Harga Novel    :");
    int hargaNovel = Integer.parseInt(br.readLine());
    ...
    System.out.println(
            "------------------------------------------------------");
    System.out.println(
            "|       Data Novel berhasil ditambahkan !            |");
    System.out.println(
            "------------------------------------------------------");
}
...
static void tambahPernakPernik(ArrayList<HarryPotter> Hp, BufferedReader br) throws IOException {
    System.out.println(
            "------------------------------------------------------ -----");
    System.out.println(
            "| Silahkan Menambah Data Pernak Pernik di Toko Wizardneeds |");
    System.out.println(
            "------------------------------------------------------------");

    System.out.println("Masukkan ID Pernak Pernik    :");
    String idPernakPernik = br.readLine();
    System.out.println("Masukkan Nama Pernak Pernik  :");
    String namaPernakPernik = br.readLine();
    System.out.println("Masukkan Stok Pernak Pernik  :");
    int stokPernakPernik = Integer.parseInt(br.readLine());
    System.out.println("Masukkan Harga Pernak Pernik :");
    int hargaPernakPernik = Integer.parseInt(br.readLine());
...
static void ubahData(ArrayList<HarryPotter> Hp, BufferedReader br) throws IOException {
    ...
    for (HarryPotter barang : Hp) {
        if (barang.getIdBarang().equals(idbarang)) {
            ...
            // Memeriksa apakah objek adalah instance dari Novel
            if (barang instanceof Novel) {
                ((Novel) barang).setJudulNovel(namaBaru); // Mengubah judul novel
            } else if (barang instanceof PernakPernik) {
